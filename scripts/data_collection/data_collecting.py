...
#
#     # Create a file for saving data labels.
#
#     csv_file_path = os.path.join(data_dir, 'data_log.csv')
#     csv_file = open(csv_file_path, 'a', newline='')
#     csv_writer = csv.writer(csv_file)
#     if os.stat(csv_file_path).st_size == 0:  # Check if file is empty to write headers.
#         csv_writer.writerow(['timestamp', 'image_filename', 'action'])
#
#     quit = False
#     while not quit:
#         env.reset()
...
#             total_reward += r
#             if steps % 10 == 0 and steps > 10:
#
#                 # Save the snapshot of the world.
#
#                 image_data = env._render(mode="rgb_array")
#
    ...
    while not quit:
        ...
        while True:
            ...
            if steps % 10 == 0 and steps > 10:
                    ...
                    # Log the image label in the csv file, as one-hot encoded vector.
                    csv_writer.writerow([timestamp, image_filename, str(log)])
                    csv_file.flush()
                    log = np.array([0, 0, 0, 0, 0])
            steps += 1
            if terminated or truncated or restart or quit:
